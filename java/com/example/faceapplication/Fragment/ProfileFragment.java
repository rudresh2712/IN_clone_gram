...
import com.example.faceapplication.Adapter.MyFotosAdapter;
import com.example.faceapplication.EditProfileActivity;
...
import com.example.faceapplication.OptionsActivity;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        options.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in=new Intent(getContext(), OptionsActivity.class);
                startActivity(in);
            }
        });
        ...
        following.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent in= new Intent (getContext(), FollowersActivity.class);
                in.putExtra("id",profileid);
                in.putExtra("title","following");
                startActivity(in);
            }
        });
    ...
    {
        DatabaseReference references = FirebaseDatabase.getInstance().getReference("Users").child(profileid);
...
//                else
//                    Glide.with(getContext()).load("gs://faceapplication-6038d.appspot.com/propic.png").into(image_profile);
    ...
    private void getFollowers(){
        ...
        DatabaseReference references2 = FirebaseDatabase.getInstance().getReference()
                .child("Follow").child(firebaseUser.getUid()).child("following");
        references2.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
    ...
    private void mysaves(){
        ...
        DatabaseReference references = FirebaseDatabase.getInstance().getReference("Saves")
